<form class="forms" data-url="{{ url('admin/bank/'.$data->id) }}" method="POST" data-reqimage="logo">
  ...
  <div class="modal-body">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" name="account_name" value="{{ $data->account_name }}" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" class="form-control" name="account_number" value="{{ $data->account_number }}" required>
      </div>
    </div>
